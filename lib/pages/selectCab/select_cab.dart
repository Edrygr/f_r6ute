...
class SelectCabScreen extends StatefulWidget {
  const SelectCabScreen({super.key});

  @override
  State<SelectCabScreen> createState() => _SelectCabScreenState();
}

class _SelectCabScreenState extends State<SelectCabScreen> {
  ...
  final List cabType = ["Economy", "Luxury", "Extras"];
  ...
  cabSelectBottomSheet(Size size) {
    return Positioned(
      bottom: 0,
      right: 0,
      left: 0,
  ...
  header(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(
          left: fixPadding, right: fixPadding, top: fixPadding * 3.0),
      child: Row(
        children: [
          IconButton(
            onPressed: () {
